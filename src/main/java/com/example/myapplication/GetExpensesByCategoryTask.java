...
public class GetExpensesByCategoryTask extends AsyncTask<Void, String, Map<String, Float>> {
    ...
    public GetExpensesByCategoryTask(SQLiteDatabase db, PieChart pieChart, AppCompatActivity activity) {
        this.db = db;
        this.pieChart = pieChart;
        this.activity=activity;
    }

    public GetExpensesByCategoryTask(SQLiteDatabase db, PieChart pieChart, String startDate, String endDate, AppCompatActivity activity) {
        this.db = db;
        this.pieChart = pieChart;
